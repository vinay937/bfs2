    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='Mandatory to enter two charachters', max_length=2, verbose_name='Form Code')),
                ('recipient', models.ForeignKey(help_text='Type of user that is receiving the feedback for this form', on_delete=django.db.models.deletion.CASCADE, related_name='form', to='general.UserType')),
                ('user_type', models.ManyToManyField(help_text='Type of user that is allowed to give the feedback for this form', to='general.UserType')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
